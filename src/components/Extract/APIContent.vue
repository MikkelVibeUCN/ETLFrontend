      ...
      <div class="row-with-label" v-for="(header, index) in headers" :key="index">
        ...
        <div class="header-row">
          <select v-model="header.key" :id="'header-key-' + index">
            <option
              v-for="(key, i) in availableHeaderKeys"
              :key="i"
          ...
          <select
            v-if="getOptionsForHeader(header.key).length"
            v-model="header.value"
          >
            <option
              v-for="(option, i) in getOptionsForHeader(header.key)"
              :key="i"
            >
              {{ option }}
            </option>
          ...
          <input
            v-model="header.extra"
            :key="'auth-input-' + index"
