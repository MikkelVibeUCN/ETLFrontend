...
import type { DatabaseMetadata } from "../../types/databaseFormat";
...
export class ConfigService {
  ...
  static async loadMetadata(config: LoadConfig): Promise<DatabaseMetadata> {
    ...
    return (await this.client.post(options)) as DatabaseMetadata;
  }
